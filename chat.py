...
class StreamlitChatView:
    def __init__(self, knowledge_folder: str) -> None:
        st.set_page_config(page_title="SetonGPT", page_icon="📚", layout="wide")
        with st.sidebar:
            st.title("SetonGPT")
            ...
            with st.expander("Prompts"):
                ...
                system_message = (f"You are ChatGPT, a large language model trained by OpenAI, "
                                  ...
                                  """Your job is to act as a tutor. This means you
                                  should not directly give answers, but rather attempt
                                  to explain things step by step or by analogy. If a student
                                  ask you to complete an assignment for them, instead attempt
                                  to walk them through it step by step.""")
